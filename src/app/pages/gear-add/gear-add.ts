  ...
  template: `
    ...
    <main class="main content">
      <div class="page-header">
        ...
        <h2>Add Gear to Vault</h2>
        <p class="subtitle">Fill in the details of your gear below</p>
      </div>

      <div class="form-card">
        <form [formGroup]="form" (ngSubmit)="onSubmit()">

          <div class="photo-upload-area" (click)="fileInput.click()" (dragover)="$event.preventDefault()" (drop)="onDrop($event)">
            @if (photoPreview()) {
          ...
          <div class="fields-grid">
            <div class="field">
              ...
              <input type="text" formControlName="name" placeholder="e.g. Mechanical Keyboard" />
            ...
            <div class="field">
              <label>Model *</label>
              <input type="text" formControlName="model" placeholder="e.g. Keychron K2 Pro" />
            ...
            <div class="field">
              ...
              <input type="text" formControlName="serialNumber" placeholder="e.g. SN-2024-XXXXX" />
            ...
            <div class="field">
              ...
              <input type="text" formControlName="ownerName" placeholder="e.g. Juan dela Cruz" />
          ...
          <div class="form-actions">
            ...
            <button type="submit" [disabled]="loading()">
              @if (loading()) { Adding to vault... } @else { Add to Vault 🔒 }
            </button>
          </div>
...
export class GearAddComponent {
  ...
  onSubmit() {
    ...
    this.gearService.create(formData).subscribe({
      next: () => this.router.navigate(['/dashboard']),
      error: (err) => {
        this.errorMsg.set(err.error?.message || 'Failed to add gear.');
